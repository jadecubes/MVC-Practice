...
set CLASSPATH=%APP_HOME%\lib\books-1.0-SNAPSHOT.jar;%APP_HOME%\lib\jrails-1.0-SNAPSHOT.jar

@rem Execute books
"%JAVA_EXE%" %DEFAULT_JVM_OPTS% %JAVA_OPTS% %BOOKS_OPTS%  -classpath "%CLASSPATH%" books.Main %CMD_LINE_ARGS%
...
if  not "" == "%BOOKS_EXIT_CONSOLE%" exit 1
exit /b 1
